---
title: "Component response rate variation underlies the stability of highly complex finite systems (Supplementary Information)"
...
**This supplemental information supports the manuscript "Component response rate variation underlies the stability of highly complex finite systems" with additional analyses to support its conclusions. All text, code, and data underlying this manuscript are publicly available on [GitHub](https://github.com/bradduthie/RandomMatrixStability) as part of the RandomMatrixStability R package.**
