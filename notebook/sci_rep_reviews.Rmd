...
This is unique, as most studies make the simplifying assumption of \sigma = \sqrt{S} such that the circular matrix has a radius of unity. 

Ideally, an analytical proof could demonstrate the uncertainty in the position of the leading eigenvalue at finite S, which would likely require knowledge of the distribution of M = \gamma A for arbitrary values of \sigma and S.




For matrices of the form $M = XA$, Gibbs et al. (2018) do find the boundaries of support for spectral densities. 


My focus is uniquely on a finite S. This is important, as Ahmadian et al. (2015) showed that any realisation of the eigenvalue distribution for a matrix of the form Z = M + LJR approaches the expected distribution as S \to infty. 


Elements of M = XA are no longer independent.
