...
response rates (\(E[\gamma]\)) of individual components to perturbations
of the system are identical, but this is highly unlikely in any complex
...
Proportions of \(\Re(\lambda) < 0\) are 0.719 and 0.737 for a and b,
respectively.
