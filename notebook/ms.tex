...
increasing \(\sigma\). Here I show that, despite higher \(\sigma\),
...
rates vary. My results are robust across commonly observed network
...
variation in component response rate (\(\sigma_{\gamma}\)) affect
complex systems. In the absence of such variation
(\(\sigma_{\gamma} = 0\)), \(\gamma\) is set to the identity matrix
(diagonal elements all equal 1) and \(\textbf{M} = \textbf{A}\). Given
this baseline condition, \(\max(\Re(\lambda))\) for
\(\textbf{M} = \textbf{A}\) can be estimated from five
values\textsuperscript{\protect\hyperlink{ref-Tang2014b}{19}}. These
values include (1) system size (\(S\)), (2) mean self-regulation of
components (\(d\); i.e., mean diagonal element of \(\textbf{M}\)), (3)
mean interaction strength between components (\(\mu\)), (4) the standard
deviation between component interaction strengths (\(\sigma\)), and (5)
the correlation of interaction strengths between components, \(M_{ij}\)
and \(M_{ji}\) (\(\rho\)).

When investigating the effect of varying component response rate
\(\sigma_{\gamma}\) on stability by defining
...
before and after adding \(\gamma\)). What \(\sigma_{\gamma}\) does
change is the variation in component interaction strengths, and
\(\rho\). Introducing variation in \(\gamma\) increases the total
variation in the system, making it more likely that
\(\textbf{M} = \gamma\textbf{A}\) is unstable. Variation of the
off-diagonal elements in \(\textbf{M}\) is described by the joint
variation of two random variables (to simplify the notation,
\(\sigma^{2}_{M}\) and \(\sigma^{2}_{A}\) refer to variances of
...
so equation \ref{var_full} can be simplified,
...
exhaustively\textsuperscript{\protect\hyperlink{ref-Hamblin2013}{23}}.
...
positive at
equilibrium\textsuperscript{\protect\hyperlink{ref-Grilli2017}{5},\protect\hyperlink{ref-Dougoud2018}{24},\protect\hyperlink{ref-Song2018}{25}}.
...
realistic\textsuperscript{\protect\hyperlink{ref-Dougoud2018}{24}}.
...
Serván et al.\textsuperscript{\protect\hyperlink{ref-Servan2018}{26}}
...
of
species\textsuperscript{\protect\hyperlink{ref-Grilli2017}{5},\protect\hyperlink{ref-Stone2017}{22},\protect\hyperlink{ref-Dougoud2018}{24},\protect\hyperlink{ref-Servan2018}{26}}
...
May\textsuperscript{\protect\hyperlink{ref-May1972}{1},\protect\hyperlink{ref-May1973}{27}},
...
In matrix notation\textsuperscript{\protect\hyperlink{ref-May1973}{27}},
...
May\textsuperscript{\protect\hyperlink{ref-May1972}{1},\protect\hyperlink{ref-Ahmadian2015}{20},\protect\hyperlink{ref-May1973}{27}}.
...
evolution\textsuperscript{\protect\hyperlink{ref-Hamblin2013}{23}}. In
...
al.\textsuperscript{\protect\hyperlink{ref-Dougoud2018}{24}} identify
...
stability
criterion\textsuperscript{\protect\hyperlink{ref-Dougoud2018}{24}} by
...
also\textsuperscript{\protect\hyperlink{ref-Servan2018}{26}}),
...
23. Hamblin, S. On the practical usage of genetic algorithms in ecology
and evolution. \emph{Methods in Ecology and Evolution} \textbf{4,}
184--194 (2013).

\hypertarget{ref-Dougoud2018}{}
24. Dougoud, M., Vinckenbosch, L., Rohr, R., Bersier, L.-F. \& Mazza, C.
...
25. Song, C. \& Saavedra, S. Will a small randomly assembled community
be feasible and stable? \emph{Ecology} \textbf{99,} 743--751 (2018).

\hypertarget{ref-Servan2018}{}
26. Serván, C. A., Capitán, J. A., Grilli, J., Morrison, K. E. \&
...
27. May, R. M. Qualitative stability in model ecosystems. \emph{Ecology}
...
Proportions of \(\Re(\lambda) < 0\) are 0.718 and 0.742 for a and b,
respectively.
