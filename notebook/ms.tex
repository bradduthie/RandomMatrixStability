...
elements \(A_{ij} \leq 0\) were constructed by first building a random
...
sampled, \(\gamma_{i} \sim \mathcal{U}(0, 2)\).
...
\(\gamma\) by randomly sampling \(\gamma_{i} \sim \mathcal{U}(0, 2)\).
