...
Gibbs et al\textsuperscript{\protect\hyperlink{ref-Gibbs2017}{4}}, which
...
While I focused on the probability of observing a stable versus unstable
system given variation in \(\mathbf{\gamma}\) for finite by high system
size (\(S\)), Gibbs et
al.\textsuperscript{\protect\hyperlink{ref-Gibbs2017}{4}} instead
focused on the different question concerning the effect of
\(\mathbf{\gamma}\) on the stability of \(\mathbf{M}\) given
\(\mathbf{A}\) as \(S \to \infty\). It is easy to show that my primary
results in \protect\hyperlink{IncrS}{the table above} are consistent
with Gibbs et al.\textsuperscript{\protect\hyperlink{ref-Gibbs2017}{4}}
by calculating the probability that system stability changes as \(S\)
increases. Gibbs et
al.\textsuperscript{\protect\hyperlink{ref-Gibbs2017}{4}} predict that
the probability that stability is altered should decrease with
increasing \(S\).

\includegraphics{SI_files/figure-latex/unnamed-chunk-26-1.pdf}

Note, however, that within this finite range of \(S\), the probability
that an unstable system will be stabilised by \(\gamma\) increases as
\(S\) increases. In other words, the proportion of unstable systems that
are stabilised by \(\gamma\) increases with \(S\) in simulations.

\includegraphics{SI_files/figure-latex/unnamed-chunk-27-1.pdf}
