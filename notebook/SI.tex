...
\hypersetup{
            pdftitle={Component response rate variation underlies the stability of highly complex finite systems (Supplementary Information)},
...
complex finite systems (Supplementary Information)}
...
``Component response rate variation underlies the stability of highly
complex finite systems'' with additional analyses to support its
conclusions. All text, code, and data underlying this manuscript are
