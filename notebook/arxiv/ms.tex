...
May's\textsuperscript{\protect\hyperlink{ref-May1972}{1},\protect\hyperlink{ref-Allesina2012}{2}} stability criterion \(\sigma\sqrt{SC} < 1\) assumes that individual components respond
...
see \hyperlink{SIstart}{Supplementary Information}). For each of 40000 
random \(M\) (\(\sigma = 0.4\), \(C = 1\)), the
