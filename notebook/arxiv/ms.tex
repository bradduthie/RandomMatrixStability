...
\(\boldsymbol{\gamma}\) is especially important for stability in
highly complex systems, in which the probability of stability would
...
realistic complex systems (such that \(S\) is high but finite) are actually 
more likely to be stable if their individual component response rates vary.
...
(\(S \to \infty\)) for a given magnitude of complexity \(\sigma\sqrt{SC}\). 
My numerical results do not contradict this
prediction because I did not scale \(\sigma = 1 / \sqrt{S}\), but
instead fixed \(\sigma\) and increased \(S\) to thereby increase total
system complexity (see Supplementary Information for
...
reduced to the below\textsuperscript{\protect\hyperlink{ref-Servan2018}{22}},
...
Supplementary information, and running all code; additional documentation
...
contents}\label{Supplementary-information-table-of-contents}
...
Gibbs et al.\textsuperscript{\protect\hyperlink{ref-Gibbs2017}{5}}, which
...
\begin{figure}[h]
\includegraphics{unnamed-chunk-27-1}
\end{figure}
...
\includegraphics{unnamed-chunk-35-1.pdf}
