...
\(S\) ranging from 2-32 (see \hyperlink{SIstart}{Supplementary Information}
for different values of \(\sigma\) and \(C\)). One million \(M\) were simulated 
...
magnitude higher than when \(\gamma = 1\) (see \hyperlink{SIstart}{Supplementary Information}).
...
\href{https://github.com/bradduthie/random_matrix_stability/blob/master/sim_results/bi_gamma/bi_pr_st.csv}{available
on GitHub}).
