...
Small-world networks were constructed using the method of Watts and Strogatz [@Watts1998]. A random matrix $\mathbf{J}$ was generated, then a network $\mathbf{S}$ to get $\mathbf{A} = \mathbf{J} \odot \mathbf{S}$
