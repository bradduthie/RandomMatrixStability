...
In the above, $\mathbf{\gamma}$ is a diagonal matrix in which elements correspond to individual component response rates. Therefore, $\mathbf{M} =\mathbf{\gamma} \mathbf{A}$ modulates the values of components and can be analysed using the techniques of May[@May1972; @May1973; @Ahmadian2015]. 
