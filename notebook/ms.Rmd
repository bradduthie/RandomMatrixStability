...
It is important to emphasise that variation in component response rate is not stabilising per se; that is, adding variation in component response rate to a particular system does not necessarily increase the probability that the system will be stable. Rather, systems that are observed to be stable are more likely to have varying component response rates, and for this variation to be critical to their stability (Fig. 3). This is caused by the shift to a non-uniform distribution of eigenvalues that occurs by introducing $Var(\gamma)$ (Fig. 1b, 2b), which can sometimes cause all of the real components of the eigenvalues of the community matrix $\mathbf{M}$ to become negative, but might also increase the real components of eigenvalues. The mathematics underlying this shift in eigenvalue distribution has been investigated [@Ahmadian2015] and recently applied to questions concerning species density and feasibility [@Gibbs2017; @Stone2017], but has not been interpreted as rates of response of individual system components to perturbation. 

<!--- 

Also important to emphasise Gibbs result -- I'm doing this for finite systems, and I deliberate stressed the system complexity to the point of collapse. 

But Gibbs was more interested in first assuming a stable matrix and then showing that the vector of abundances would not change it as S \to infinity -- Instead of assuming the system was stable prior to adding component response rate, I allow both the system and component response rate to vary to see the effects on stability.
