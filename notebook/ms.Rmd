...
sim_rhos <- read.csv(file = "../inst/extdata/rhos/sim_rhos.csv");
par(mar = c(5, 5, 1, 1));
...
```{r, echo = FALSE, fig.height = 7.5, fig.width = 6}
sim10 <- read.csv(file = "../inst/extdata/rhos/sim10.csv");
sim15 <- read.csv(file = "../inst/extdata/rhos/sim15.csv");
sim20 <- read.csv(file = "../inst/extdata/rhos/sim20.csv");
sim25 <- read.csv(file = "../inst/extdata/rhos/sim25.csv");
sim30 <- read.csv(file = "../inst/extdata/rhos/sim30.csv");
sim35 <- read.csv(file = "../inst/extdata/rhos/sim35.csv");
sim40 <- read.csv(file = "../inst/extdata/rhos/sim40.csv");
sim45 <- read.csv(file = "../inst/extdata/rhos/sim45.csv");
