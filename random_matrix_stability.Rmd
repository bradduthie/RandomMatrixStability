...
x1     <- 2:15;
x1_adj <- c(0.27, 0.25, 0.23, 0.21, 0.21, 0.20, 0.19, 0.18, 0.17, 0.16, 0.15,
            0.14, 0.13, 0.12);
plot(x = x1 + x1_adj, y = y1, xaxt = "n", yaxt = "n", lwd = 2, ylim = c(0, 1),
     xlab = "", ylab = "", type = "b", xlim = c(2, 15));

#plot(x = gen_var[,1], y = y1, type = "b", lwd = 2, ylim = c(0, 1),
#     ylab = "Pr. stable due to Var(\u03b3)",
