...
- I am still working out what this means conceptually by multiplying each row of the matrix by a single number, the shape of the matrix is somehow being changed to decrease the eigenvalues.
- The exception to this is mutualistic communities -- variation in generation time had zero effect on mutualist community stability.
