...
Switch code so that the same matrix is checked for stability before and after generation change is added. Then record number stabilised versus unstabilised. Show a plot with the proportion stabilised by varying generation time.
