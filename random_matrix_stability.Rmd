...
The number of stable random matrices when $\varepsilon$ does not vary was $13$, and the number of stable random matrices when it does was $48$. To further investigate, it is worth looking at **how the amount of variation in generation time in a community affects stability**. Below is some code to look at stability in random communities across different magnitudes of variance in generation time for communities with eight species.
