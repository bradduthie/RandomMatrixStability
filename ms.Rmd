...
**Idea**: Since the *variance* of the off-diagonal elements (relative to the diagonals? Perhaps the diagonal values?) affects stability -- increased variance increases stability, the relevance of $\gamma$ increases with increasing system size because the variance also increases -- more off-diagonal elements relative to diagonals, and we're essentially adding a new source of variation, $\gamma$

**Idea**: Look at what happens to feasibility when r < 0 for all species. Could even potentially make the argument that this is *expected* for real communities, because in the absence of other components of the system (producers, nutrients, whatever), the growth rate of a population *must* be negative?
